...
def main():
    ...
    # Seaborn's heatmap to better visualize the confusion matrix
    sns.heatmap(nn_cm/np.sum(nn_cm), annot=True, fmt='.2%', linewidths = 0.30)
    pyplot.show()
    ...
    #-----------------------------------------------------------------------------------
    # print("7")
    # print(dataframe_dict[4].iloc[36])
    # print(dataframe_dict[4].iloc[41])
    # #print(dataframe_dict[5].iloc[36][1])
    # print(wasserstein_distance(dataframe_dict[4].iloc[36][1], dataframe_dict[4].iloc[36][2]))
    # print(wasserstein_distance(dataframe_dict[4].iloc[41][1], dataframe_dict[4].iloc[41][2]))
    
    # print("9")
    # print(wasserstein_distance(dataframe_dict[1].iloc[7], dataframe_dict[1].iloc[9]))
    # print(wasserstein_distance(dataframe_dict[1].iloc[104], dataframe_dict[1].iloc[109]))
    
    # print(wasserstein_distance(dataframe_dict[1].iloc[2], dataframe_dict[1].iloc[5]))
    # print(wasserstein_distance(dataframe_dict[1].iloc[135], dataframe_dict[1].iloc[137]))
    ...
    for index in range(1,nn_layers):
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(rf_cm/np.sum(rf_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    ...
    for index in range(1,nn_layers):
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(knn_cm/np.sum(knn_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    ...
    for index in range(1,nn_layers):
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(mlp_cm/np.sum(mlp_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    ...
    for index in range(1,nn_layers):
        ...
        print("Accuracy:", metrics.accuracy_score(Model_test_data_labels, c_cent_pred))
        
        print("EVALUATION ON Nearest centroidClassifier TESTING DATA")
        print(classification_report(Model_test_data_labels, c_cent_pred))
        
        cent_cm = pd.DataFrame(confusion_matrix(Model_test_data_labels, c_cent_pred), 
                      columns=Model_classes, index = Model_classes)
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(cent_cm/np.sum(cent_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    ...
    for index in range(1,nn_layers):
        ...
        acc = svm_model_linear.score(dataframe_dict[index],Model_test_data_labels)
        svm_cm = pd.DataFrame(confusion_matrix(Model_test_data_labels, svm_pred), 
                          columns=Model_classes, index = Model_classes)
        
        print("EVALUATION ON SVC Classifier TESTING DATA")
        print(classification_report(Model_test_data_labels, svm_pred))
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(svm_cm/np.sum(svm_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    ...
    for index in range(1,nn_layers):
        ...
        dtree_model.fit(new_dataframe_dict[index], valLabels)
        
        dtree_pred  = dtree_model.predict(dataframe_dict[index])
        
        dtree_cm = pd.DataFrame(confusion_matrix(Model_test_data_labels, dtree_pred), 
                          columns=Model_classes, index = Model_classes)
    
        print("EVALUATION ON DTree Classifier TESTING DATA")
        print(classification_report(Model_test_data_labels, dtree_pred))
        ...
        # Seaborn's heatmap to better visualize the confusion matrix
        sns.heatmap(dtree_cm/np.sum(dtree_cm), annot=True, fmt='.2%', linewidths = 0.30)
        pyplot.show()
    #------------------------------------------------------------------------------------------
