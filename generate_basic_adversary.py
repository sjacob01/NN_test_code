...
def generate_adversaries(sccLoss, optimizer, EPS, model, baseImage, delta, classIdx, steps=50):
...
def main():
    ...
    deltaUpdated = generate_adversaries(sccLoss,optimizer, EPS, model, baseImage, delta,
        args["class_idx"])
